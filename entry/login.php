      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
                ...
                <h4 class="form-login-heading" ><?php echo $msg ?></h4>
		        <div class="login-wrap">
		            ...
		            <label class="checkbox">
		                <span class="pull-right">
                            ...
                            <button class="btn btn-theme btn-block" name="loginbtn" type="submit"><i class="fa fa-lock"></i> SIGN IN</button>
		            <hr>
